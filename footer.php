                ...
                <div class="col-md-4 col-sm-6 widget-container">
                    <div id="text-2" class="widget widget_text">
                        ...
                        <div class="textwidget">
                            Libraria is your go-to library management system, designed to streamline the borrowing process, manage books, and provide a seamless experience for both library staff and members.
                        </div>
                        <address>
                            <div class="info">
                ...
                <div class="col-md-4 col-sm-6 widget-container">
                    <div class="widget twitter-widget">
                        ...
                        <div id="twitter-feed">
                            <ul>
                                <li>
                                    <p><a href="#">@LibrariaUpdates</a> Check out our latest addition to the library catalog: "The Art of Libraries". <a href="#">libraria.com</a></p>
                                </li>
                                <li>
                                    <p><a href="#">@LibrariaNews</a> Don’t forget to sign up for our upcoming online seminar on library management! <a href="#">libraria.com</a></p>
                                </li>
                            </ul>
                        </div>
                    </div>          
        ...
        <div class="container">
            <div class="row">
                <div class="footer-text col-md-3">
                    <p><a target="_blank" href="http://localhost:90/L5104/index.php">Visit our Website</a></p>
                </div>
                <div class="col-md-9 pull-right">
                    <ul>
                        <li><a href="index.php">Home</a></li>
                        <li><a href="borrow.php">Books</a></li>
